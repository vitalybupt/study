...
public interface WikiDatabaseService {
    ...
    @GenIgnore
    static io.vitaly.vertx.database.reactivex.WikiDatabaseService createProxy(Vertx vertx, String address) {
    	return new io.vitaly.vertx.database.reactivex.WikiDatabaseService(new WikiDatabaseServiceVertxEBProxy(vertx, address));
    }
